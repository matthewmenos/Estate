...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      className="flex items-center justify-center gap-2 w-full rounded-xl border border-ink text-ink py-2 text-sm font-medium hover:bg-ink hover:text-paper-raised transition-colors"
    >
