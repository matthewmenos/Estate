    ...
    <div className="min-h-screen bg-ink flex flex-col md:flex-row">
      ...
      <aside className="md:w-56 shrink-0 border-b md:border-b-0 md:border-r border-paper/10">
        ...
        <div className="px-2 pb-5 border-t border-paper/10 pt-3 hidden md:block space-y-1">
          <Link
            href="/dashboard"
            className="block px-3 py-2 rounded-xl text-sm text-paper/60 hover:text-paper hover:bg-paper/5 transition-colors"
          >
            My owner dashboard
          </Link>
          <Link
          ...
          <button
            ...
            className="block w-full text-left px-3 py-2 rounded-xl text-sm text-paper/60 hover:text-paper hover:bg-paper/5 transition-colors"
          >
            Sign out
          </button>
        </div>
